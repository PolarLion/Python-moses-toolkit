...
bplm_working = "/home/xwshi/working/cht/blm/"
...
def extract_training (cfg_info) :
	...
	os.system ("/home/xwshi/moses/bilingual-lm/extract_training.py "
		+ " --working-dir " + bplm_working
		+ " --corpus " + cfg_info.training_path + "../" + cfg_info.filename + ".clean " \
		+ " --source-language zh-cn "  #+ cfg_info.training_path + "../" + cfg_info.filename + ".true." + cfg_info.source_id \
		+ " --target-language en "# + cfg_info.training_path + "../" + cfg_info.filename + ".true." + cfg_info.target_id \
		+ " --align " + bplm_working + "../train/model/aligned.grow-diag-final-and " \
...
def train_nplm (cfg_info) : 
	...
	os.system ( "/home/xwshi/moses/bilingual-lm/train_nplm.py "
 		+ " --working-dir " + bplm_working \
		+ " --corpus " + cfg_info.training_path + "../" + cfg_info.filename + ".clean " \
		+ " --nplm-home " + path_to_nplm \
		+ " --ngram-size 6 " \
		+ " --epochs 40 " \
		+ " --learning-rate 1 " \
...
def run_test (cfg_info) :
	...
	os.system ( "nohup nice " + cfg_info.mosesdecoder_path + "bin/moses -threads 32 -f " \
		+ cfg_info.working_path + "moses.ini " \
